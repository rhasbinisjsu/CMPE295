...
//     axios.get(`http://localhost:8080/CropSense/AppServer/FarmController/fetchFarmsForOwner?ownerId=1`)
//       .then(response => {
...
//       },
//       pins: pins, // Include pins data in the payload
//     };
    
//     axios.post('http://localhost:8080/CropSense/AppServer/FarmController/createFarm', newFarm)
//       .then(response => {
