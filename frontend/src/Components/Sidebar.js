...
const Sidebar = () => {
  return (
    <div className="h-screen w-64 bg-white text-black border border-gray-300">
      ...
      <nav className="mt-5">
        <a href="#" className="block text-lg text-indigo-700 font-bold py-4 px-10 rounded transition duration-200 bg-indigo-100 hover:bg-gray-700 hover:text-white flex items-center">
          <HomeIcon className="h-5 w-5 mr-2" />
          Dashboard
        </a>
        <a href="#" className="block text-lg py-4 px-10 rounded transition duration-200 hover:bg-gray-700 hover:text-white flex items-center">
